...
function keyPressed() {
  ...
  {
    brain.loadData('exercise1.json', dataReady);
  }
}

function setup() 
{
    speakText("raise your right arm and stretch");
...
localStorage.setItem('exerciseCount', count);

// Redirect to the exercise summary page when counter reaches 5
if (count === 5) {
...
function speakText(text, count = 5) {
  let i = 0;
