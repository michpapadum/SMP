...
function setup() {
  speakText("raise your left arm and stretch");
  ...
  const modelInfo = {
    ...
    metadata: 'model/model2_meta.json',
    weights: 'model/model2.weights.bin',
  };
...
function updateCount(poseLabel){
  ...
  if (lastLabel === 'R' && poseLabel==='0'){
    ...
    if (count >= 5) {
      ...
      window.location.href="exercisesummary2.html"
  }
}
  lastLabel=poseLabel;
}
